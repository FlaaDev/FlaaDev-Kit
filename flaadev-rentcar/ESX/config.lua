Shared = {
    pedModel = "s_m_y_airworker", --hash = 1644266841
    pzones = {
        zone1 = { --Legion Square
    ...
    cars = {
        ...
        { name = "Adder",      id = "kamacho", text = "The slowest one!", isCar = true,  price = 2000 },
        { name = "Shinobi",   id = "shinobi", text = "The one!",         isCar = false, price = 1000 },
    },
    licenseItemName = "driver_license",
    rentalPaperName = "rentalpaper",
    rentalFeesPrice = 5000,
    carFeesPrice = 10000
}
